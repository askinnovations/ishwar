  ...
  <div class="page-content">
    ...
    <div id="addMaintenanceModal" class="modal fade" tabindex="-1" aria-hidden="true">
      ...
      @enderror
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="addOdometer" name="odometer_reading" required>
    ...
    <div id="updateMaintenanceModal" class="modal fade" tabindex="-1" aria-hidden="true">
      ...
      @enderror
          ...
          <div class="col-md-6 mb-3">
            <label class="form-label">📏 Odometer Reading</label>
            <input type="text" class="form-control" id="editOdometer" name="odometer_reading" required>
            @error('odometer_reading')
        <small class="text-danger">{{ $message }}</small>
      @enderror
          </div>
